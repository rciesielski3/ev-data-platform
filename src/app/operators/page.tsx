  ...
  return (
    <main className="mx-auto max-w-6xl px-6 py-12">
      ...
      <ActionBar>
        ...
        <a href="/api/exports/operators?format=csv" className="text-sm font-medium text-emerald-700 hover:text-emerald-900">
          {t("exportCsvLink")}
        </a>
        <a href="/api/exports/operators?format=json" className="text-sm font-medium text-emerald-700 hover:text-emerald-900">
          {t("exportJsonLink")}
        </a>
      </ActionBar>
